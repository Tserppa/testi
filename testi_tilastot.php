...
$reason_l1t = "SELECT reason_l1,channel,technique,COUNT(*) as count FROM b2ctap WHERE pvm LIKE '$pvm' GROUP BY reason_l1 ORDER BY count DESC LIMIT 20";
$result3 = mysqli_query ( $conn, $reason_l1t );
if ($result3->num_rows > 0) {
