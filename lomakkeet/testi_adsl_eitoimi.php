...
<form name='lomake'>
    ...
    <div id="toimintaohje3" class="ohje">Jos asiakkaalla on muualta hankittu tai takuuton laite -> myy modeemi!
    </div>
    <div id="tehdasasetukset2" class="koe">
        ...
        <input type='radio' onclick='tehdasasetukset23();' id='tehdasasetukset23id' name='tehdasasetukset' value='Asiakas ei ole kotona, mutta testaa kun pystyy'><label for='tehdasasetukset23id'>Ei ole
            kotona, testaa sitten kun pystyy</label>
        <input type='radio' onclick='tehdasasetukset24();' id='tehdasasetukset24id' name='tehdasasetukset' value='Ei auttanut ja modeemi on aiemmin vaihdettu'><label for='tehdasasetukset24id'>Ei
            auttanut, modeemi on jo vaihdettu tämän vian vuoksi</label>
    </div>
    <div id="toimintaohje4" class="ohje">Takuumodeemeissa tehdään tarvittaessa softan päivitys ja mahdollinen laitteen vaihto prosessin mukaan. Jos asiakkaalla on muualta hankittu tai takuuton laite -> myy modeemi!
    </div>
    ...
    <div id="toimintaohje6" class="ohje">Oletettavasti asiakkaan modeemi on vialla. Tämän varmistamiseksi olisi hyödyllistä testata toisella modeemilla asiakkaan omassa liittymässä, jotta voidaan esim. lähettää tai myydä uusi modeemi.
    </div>
    ...
    <div id="toimintaohje5" class="ohje">Jos ei ole toiminut koskaan ja toimituksesta alle 3kk, niin katso TT-ohje.
    </div>
    ...
    <div id="toimintaohje7" class="ohje">Jos ei ole toiminut koskaan ja toimituksesta alle 3kk, niin katso TT-ohje.
    </div>
    ...
    <div id="toimintaohje8" class="ohje">Suorittakaa modeemille tehdasasetusten palautus painamalla laitteen reset-painiketta HUOM! Resetointi palauttaa laitteeseen oletusarvot myös langattoman yhteyden osalta.
    </div>
    <div id="wifi_tehdas" class="koe">
        <h3>Onko tehdasasetukset palautettu?</h3>
        <input type='radio' onclick='wifi_tehdas();' id='wifi_tehdas1' name='wifi_tehdas' value='Tehdasasetukset palautettu'><label for='wifi_tehdas1'>Kyllä</label>
        <input type='radio' onclick='wifi_tehdas();' id='wifi_tehdas2' name='wifi_tehdas' value='Tehdasasetuksia ei ole palautettu'><label for='wifi_tehdas2'>Ei</label>
    </div>
    ...
    <div id="toimintaohje9" class="ohje">Pyydä asiakasta suorittamaan tehdasasetusten palautus painamalla laitteen reset-painiketta. Takuumodeemeissa softan päivitys, Mahdollinen laitteen vaihto prosessin mukaan. Jos asiakkaalla on muualta
        hankittu tai takuuton laite -> myy modeemi!
    </div>
    <div id="toimintaohje10" class="ohje">Takuumodeemeissa tehdään tarvittaessa softan päivitys ja mahdollinen laitteen vaihto prosessin mukaan. Jos asiakkaalla on muualta hankittu tai takuuton laite -> myy modeemi!
    </div>
    ...
    <div id="vakiopohjan_loppu">
        ...
        <button onclick='generoippa();' type="button">Generoi</button>
        <button onclick='tyhjenna();' type="reset">Tyhjennä</button>
        <button name='sms' id='sms' onclick='show_sms();' type="button">SMS</button>
        <br></br>
        <TEXTAREA id="asiakasinfo" class="asiakasinfo" oninput="generoippa();" placeholder="Asiakasinfot" disabled></TEXTAREA>
    </div>
</form>
</div>
<div id="oikea_palsta">
